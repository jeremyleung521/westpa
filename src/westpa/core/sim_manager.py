...
class WESimManager:
    ...
    def __init__(self, rc=None):
        ...
        self._valid_callbacks = {self.prepare_run, self.finalize_run, self.prepare_iteration, self.finalize_iteration,
                                 self.pre_propagation, self.post_propagation, self.pre_we, self.post_we,
